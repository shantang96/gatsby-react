  ...
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        ...
        <SVG icon="hexa" width={48} stroke={colors.yellow} left="60%" top="70%" />
        <SVG icon="triangle" width={48} stroke={colors.grey} left="80%" top="20%" />
        <SVG icon="box" width={6} fill={colors['grey-darker']} left="60%" top="15%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="arrowUp" hiddenMobile width={16} fill={colors['blue-dark']} left="80%" top="10%" />
        <SVG icon="triangle" width={12} stroke={colors['yellow-light']} left="90%" top="50%" />
        ...
        <SVG icon="cross" width={16} stroke={colors['pink-dark']} left="48%" top="0%" />
        <SVG icon="circle" width={6} fill={colors['grey-darkest']} left="75%" top="10%" />
        <SVG icon="upDown" hiddenMobile width={24} fill={colors['grey-darkest']} left="55%" top="10%" />
        <SVG icon="cross" width={16} stroke={colors['green']} left="76%" top="32%" />

      </UpDownWide>
      <SVG icon="circle" hiddenMobile width={24} fill={colors['grey-darker']} left="5%" top="70%" />
      <SVG icon="circle" width={6} fill={colors['blue-darkest']} left="4%" top="20%" />
      ...
      <SVG icon="box" hiddenMobile width={32} fill={colors.purple} left="5%" top="90%" />
      <SVG icon="box" width={6} fill={colors['grey-darkest']} left="10%" top="10%" />
      <SVG icon="box" width={12} fill={colors['grey-darkest']} left="40%" top="30%" />
      <SVG icon="hexa" width={16} stroke={colors['grey-darker']} left="10%" top="50%" />
      <SVG icon="hexa" width={8} stroke={colors['grey-darker']} left="80%" top="70%" />
      <SVG icon="circle" width={16} fill={colors.green} left="20%" top="97%" />
