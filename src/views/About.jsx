...
const About = ({ children, offset }) => (
  <>
    ...
    <Divider speed={0.1} offset={offset}>
      ...
      <UpDownWide>
<<<<<<< HEAD
        <SVG icon="arrowUp" hiddenMobile width={16} fill={colors["blue-dark"]} left="5%" top="80%" />
        <SVG icon="triangle" width={12} stroke={colors.grey} left="95%" top="50%" />
      ...
      <SVG icon="box" width={12} fill={colors['grey-darkest']} left="30%" top="30%" />
=======
